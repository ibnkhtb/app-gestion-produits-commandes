  ...
  return (
    <div>
      <Row className="justify-content-center border-bottom">
        <Col md="8">
          <h1 id="register-title" data-cy="registerTitle" className='mycolorText1'>
        ...
        <Col md="8">
          <ValidatedForm id="register-form" onSubmit={handleValidSubmit} >
            ...
            <ValidatedField
              ...
              validate={{
                required: { value: true, message: 'minimum 8 caracteres' },
                minLength: { value: 8, message: 'minimum 8 caracteres' },
                maxLength: { value: 50, message: 'minimum 50 caracteres' },
              }}
